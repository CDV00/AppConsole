...
namespace TestLinq
{
    internal class Students
    {
        ...
        public Students(string FirstName, string LastName, int ID, GradeLevel Year, List<int> ExamScores)
        {
        ...
        public Students(string FirstName, string LastName, int StudentID, List<int>? ExamScores = null)
        {
            this.FirstName = FirstName;
            this.LastName = LastName;
            ID = StudentID;
        ...
        public static List<Students> students = new()
    {
        new(
